...
<body>
 ...
 <a class="leftHeader" href="http://localhost:8080/shop/">Home</a>
 <a class="leftHeader" href="contact">Contact    </a>
 <a class="leftHeader" href="payment">Payment    </a>
 <a class="leftHeader" href="delivery">Delivery    </a>
...
<div>
	<div class="div-header-left">
		<img id="header-label" src="${pageContext.request.contextPath}/resources/assets/img_assets/shop_label.jpeg" onerror="this.src='${pageContext.request.contextPath}/resources/assets/img_assets/image-not-found.jpg'"   />
	</div>
	<div class="div-header-search">
		<div>
			<p id = "contact-mail">lysko_9191@mail.ru</p>
		</div>
		<form:form method="GET" action="client" class="editFields">
			<div>
				<input  id="search-for-models" name="search" placeholder="Search for brend">
			</div>
		</form:form>
	</div>
